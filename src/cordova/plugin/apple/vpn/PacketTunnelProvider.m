...
- (id)init {
  self = [super init];
#if TARGET_OS_IPHONE
  NSString *appGroup = @"group.com.beepassvpn.ios.client";
#else
  NSString *appGroup = @"5AB283HLKN.com.beepassvpn.macos.client";
#endif
  ...
  _packetQueue = dispatch_queue_create("com.beepassvpn.ios.packetqueue", DISPATCH_QUEUE_SERIAL);
